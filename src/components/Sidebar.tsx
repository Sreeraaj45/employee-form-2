...
export default function Sidebar({
  ...
  return (
    <>
      {/* ---------- DESKTOP SIDEBAR (unchanged view) ---------- */}
      <div className="hidden md:flex bg-white h-full w-52 shadow-lg flex flex-col border-r border-gray-200">
        {/* Logo & Header */}
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Icon */}
                    <div
                      className={`p-1.5 rounded-md bg-gradient-to-br ${tab.gradient} shadow-sm flex-shrink-0 ${
      ...
      {/* ---------- MOBILE: only bottom navigation (Responses, Analytics, Logout) ---------- */}
      <div className="md:hidden">
        <nav className="fixed left-0 right-0 bottom-0 z-40 bg-white border-t border-gray-200">
          <div className="max-w-xl mx-auto px-4">
            <div className="flex items-center justify-between h-16">
              ...
              >
                <List
                  className={`w-6 h-6 ${activeTab === "responses" ? "text-blue-600" : "text-gray-500"}`}
                />
                <span className={`text-xs ${activeTab === "responses" ? "text-blue-600" : "text-gray-500"}`}>
                  Responses
                </span>
              </button>
              ...
              >
                <BarChart3
                  className={`w-6 h-6 ${activeTab === "analytics" ? "text-blue-600" : "text-gray-500"}`}
                />
                <span className={`text-xs ${activeTab === "analytics" ? "text-blue-600" : "text-gray-500"}`}>
                  Analytics
                </span>
              </button>
